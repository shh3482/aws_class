...
public class EX08_Operator2 {
	...
	public static void main(String[] args) {
		 ...
		 * - 주의사항
		 *   - js와 약간 다름
		 *   - js는 1 || 0 => true || false로 인식
		 *   - 자바는 무조건 true, false만 와야함
		 */
		
		// 성적이 90이상 100이하이면 A일 때 &&, ||, !중에 어떤 연산을 써야 할까요?
		// 정답은 &&, 성적이 90이상이고 100이하이다 라고 표현
		
		// 졸업하려면 토익이 600이거나 영어회화 과목을 이수해야 한다.
		// 정답은 ||
		int score = 95;
		...
		/* 단락 회로 평가(SCE : Short Circuit Evaluation)(77페이지)
		 * - 논리 연산자로 연산할 때 발생
		 * - 속도 향상
		...
		int num1 = 70, num2 = 50;
		System.out.println("num1과 num2 중 하나라도 60 이상입니까? " + (num1 >= 60 || num2 >= 60));
		...
		/* 비트 연산자 (81페이지)
		 * - 비트 논리 연산자
		 *   - 정수를 2진수로 표현한 후 각 비트를 나열한 후 논리 연산
		 *   - 1 : true, 0 : false
		 *   - |, &, ~, ^(xor)
		 *     - | : or
		 *     - & : and
		 ...
		 *     - 4 << 3 : 4 * 2^3 => 4 * 8 => 32
		 *   - a >> n : n비트씩 오른쪽으로 이동, 2^n 나눈 효과. 왼쪽은 부호 비트로 채움
